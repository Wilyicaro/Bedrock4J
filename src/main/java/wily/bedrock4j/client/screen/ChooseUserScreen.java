...
public class ChooseUserScreen extends PanelVListScreen {
    public static final Component CHOOSE_USER = Component.translatable("bedrock4j.menu.choose_user");
    public static final Component CHOOSE_USER_MESSAGE = Component.translatable("bedrock4j.menu.choose_user_message");
    public static final Component ADD_ACCOUNT = Component.translatable("bedrock4j.menu.choose_user.add");
    public static final Component ACCOUNT_OPTIONS = Component.translatable("bedrock4j.menu.choose_user.account_options");
    public static final Component DIRECT_LOGIN = Component.translatable("bedrock4j.menu.choose_user.direct_login");
    public static final Component ACCOUNT_OPTIONS_MESSAGE = Component.translatable("bedrock4j.menu.choose_user.account_options_message");
    public static final Component EDIT_ACCOUNT = Component.translatable("bedrock4j.menu.choose_user.account_options.edit");
    public static final Component DELETE_ACCOUNT = Component.translatable("bedrock4j.menu.choose_user.account_options.delete");
    public static final Component ACCOUNT_ENCRYPTION = Component.translatable("bedrock4j.menu.choose_user.add.encryption");
    public static final Component ACCOUNT_ENCRYPTION_MESSAGE = Component.translatable("bedrock4j.menu.choose_user.add.encryption_message");
    public static final Component ADD_WITH_ENCRYPTION = Component.translatable("bedrock4j.menu.choose_user.add.encryption.present");
    public static final Component ADD_WITHOUT_ENCRYPTION = Component.translatable("bedrock4j.menu.choose_user.add.encryption.absent");
    public static final Component VISIBLE_PASSWORD = Component.translatable("bedrock4j.menu.choose_user.add.encryption.visible_password");
    ...
    public void renderableVListInit() {
        addRenderableOnly(((guiGraphics, i, j, f) -> {
            FactoryGuiGraphics.of(guiGraphics).blitSprite(BedrockSprites.PANEL_RECESS,panel.getX() + 10, panel.getY() + 13, panel.getWidth() - 20, panel.getHeight() - 26);
    ...
    public static ConfirmationScreen passwordScreen(Screen parent, Consumer<String> pass){
        EditBox passWordBox = new EditBox(Minecraft.getInstance().font, 0,0,200,20,Component.translatable("bedrock4j.menu.choose_user.add.encryption.password"));
        Toggle toggle = new Toggle(0,0,true, bol->VISIBLE_PASSWORD, bol-> null, t->passWordBox.setFormatter((s, i)-> FormattedCharSequence.forward(t.selected ? s : "*".repeat(s.length()), Style.EMPTY)));
        toggle.onPress();
        return new ConfirmationScreen(parent,230, 120,passWordBox.getMessage(),Component.translatable("bedrock4j.menu.choose_user.add.encryption.password_message"), b1-> pass.accept(passWordBox.getValue())){
            @Override
            ...
            protected void init() {
                super.init();
                toggle.setPosition(panel.getX() + 15, panel.getY() + 68);
    ...
    public static ConfirmationScreen accountScreen(Component title, Screen parent, boolean allowEncryption, Consumer<MCAccount> press){
        return new ConfirmationScreen(parent,230, 120,title, CHOOSE_USER_MESSAGE){
            ...
            protected void addButtons() {
                ...
                renderableVList.addRenderable(Button.builder(Component.translatable("bedrock4j.menu.choose_user.microsoft"), b-> {
                ...
                renderableVList.addRenderable(Button.builder(Component.translatable("bedrock4j.menu.choose_user.offline"), b-> {
                    EditBox usernameBox = new EditBox(Minecraft.getInstance().font, 0,0,200,20,Component.translatable("bedrock4j.menu.choose_user.offline.username"));
                    minecraft.setScreen(new ConfirmationScreen(this, 230, 120, usernameBox.getMessage(),Component.translatable("bedrock4j.menu.choose_user.offline.username_message"), b1-> press.accept(MCAccount.create(new GameProfile(UUID.nameUUIDFromBytes(("offline:"+usernameBox.getValue()).getBytes()),usernameBox.getValue()),false,null,null))){
                        @Override
                        protected void addButtons() {
                            super.addButtons();
                            okButton.active = false;
    ...
    protected void addAccountButtons(){
        ...
        CreationList.addIconButton(renderableVList, Bedrock4J.createModLocation("icon/add_user"),ADD_ACCOUNT, b->minecraft.setScreen(accountScreen(ADD_ACCOUNT, this,true, a-> {
        ...
        for (MCAccount account : MCAccount.list) {
            renderableVList.addRenderable(new AbstractButton(0, 0, 230, 30, account.getMSARefreshToken(null).isEmpty() ? Component.translatable("bedrock4j.menu.offline_user",account.getProfile().getName()) : Component.literal(account.getProfile().getName())) {
                @Override
