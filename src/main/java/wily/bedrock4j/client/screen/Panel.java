...
public class Panel extends SimpleLayoutRenderable {
    ...
    public ResourceLocation panelSprite = BedrockSprites.PANEL;
    public String name;
    ...
    public static Panel tooltipBoxOf(Panel panel, int boxWidth){
        Panel p = new Panel(panel.accessor){
            ...
            public void init(String name) {
                ...
                appearance(BedrockSprites.POINTER_PANEL, boxWidth, panel.height - 10);
    ...
    public void appearance(int width, int height){
        appearance(BedrockSprites.PANEL,width,height);
    }
