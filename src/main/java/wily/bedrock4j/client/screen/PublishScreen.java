...
import static wily.bedrock4j.client.screen.LoadSaveScreen.GAME_TYPES;
...
public class PublishScreen extends ConfirmationScreen{
    ...
    public static final Component PUBLISH = Component.translatable(hasWorldHost() ? "bedrock4j.menu.online" : "menu.shareToLan");
    ...
    public PublishScreen(Screen parent, GameType gameType, Consumer<PublishScreen> okAction) {
        ...
        gameTypeSlider = new BedrockSliderButton<>(0,0, 200,16, b -> b.getDefaultMessage(GAME_MODEL_LABEL,b.getObjectValue().getLongDisplayName()), b->Tooltip.create(Component.translatable("selectWorld.gameMode."+b.getObjectValue().getName()+ ".info")),gameType,()->GAME_TYPES, b->{});
    }
    ...
    protected void init() {
        ...
        portEdit.setResponder(string -> {
            Pair<Integer,Component> p = Bedrock4JClient.tryParsePort(string);
