...
public class SaveOptionsScreen extends ConfirmationScreen{
    ...
    protected void addButtons() {
        ...
        renderableVList.addRenderable(Button.builder(Component.translatable("bedrock4j.menu.rename_save"),b-> minecraft.setScreen(new ConfirmationScreen(parent, 230, 121,Component.translatable("bedrock4j.menu.rename_save_title"), Component.translatable("bedrock4j.menu.rename_save_message"), p->{
            ...
            try {
                ...
                Bedrock4J.LOGGER.warn("{}", contentValidationException.getMessage());
        ...
        renderableVList.addRenderable(Button.builder(Component.translatable("bedrock4j.menu.copySave"),b-> minecraft.setScreen(new ConfirmationScreen(parent, Component.translatable("bedrock4j.menu.copySave"), Component.translatable("bedrock4j.menu.copySaveMessage"), b1->{
            String id = summary.getLevelId();
            Bedrock4JClient.copySaveFile(minecraft.getLevelSource().getBaseDir().resolve(id),minecraft.getLevelSource(),id);
            parent.saveRenderableList.reloadSaveList();
            minecraft.setScreen(parent);
