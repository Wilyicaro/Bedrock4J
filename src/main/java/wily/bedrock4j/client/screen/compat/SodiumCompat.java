...
public class SodiumCompat {
    ...
    public static AbstractWidget getSodiumOptionWidget(Option<?> option){
        ...
        if (option.getControl() instanceof TickBoxControl c) {
            return new Toggle(0,0,0,c.getOption().getValue(), b-> option.getName(), b-> tooltip, t-> {
            ...
            return BedrockSliderButton.createFromIntRange(0, 0, 0, 16, (b) -> b.getDefaultMessage(option.getName(), formatter.format(b.getObjectValue())), b -> tooltip, c.getOption().getValue(), min, max, s -> {
            ...
            return new BedrockSliderButton<>(0, 0, 0, 16, (b) -> b.getDefaultMessage(option.getName(), components[values.indexOf(b.getObjectValue())]), b -> tooltip, c.getOption().getValue(), ()->values, s -> {
                if (!Objects.equals(c.getOption().getValue(), s.getObjectValue())) {
    ...
    public static void init(){
        Bedrock4JClient.whenResetOptions.add(()-> {
