...
public class WorldHostFriendsScreen extends PanelVListScreen {
    ...
    public static final Component INVITE = Component.translatable("bedrock4j.menu.invite");
    public static final Component INVITE_FRIENDS = Component.translatable("bedrock4j.menu.invite_friends");
    ...
    public WorldHostFriendsScreen(Screen parent, int imageWidth, int imageHeight) {
        super(parent, s-> Panel.centered(s, BedrockSprites.PANEL,imageWidth,imageHeight), WORLD_HOST_FRIENDS);
    ...
    protected void addFriendButtons(Runnable afterButtonsAdd){
        CreationList.addIconButton(renderableVList, Bedrock4J.createModLocation("icon/add_user_portal"),FriendsScreen.ADD_FRIEND_TEXT, b-> minecraft.setScreen(new WorldHostFriendsScreen(this,250,234){
            long lastTyping = -1;
            ...
            final Toggle silentAddBox = new Toggle(0,0,200,16,false, b1-> AddFriendScreen.ADD_FRIEND_SILENT_TEXT, b1-> ADD_SILENTLY_TEXT_TOOLTIP, t-> {});
            ...
            private void addFriendButton(FriendListFriend friend){
                renderableVList.addRenderable(new FriendButton(0,0,230,30,friend){
                    ...
                    protected void renderWidget(GuiGraphics guiGraphics, int i, int j, float f) {
                        ...
                        FactoryGuiGraphics.of(guiGraphics).blitSprite(Toggle.SPRITES[isHoveredOrFocused() ? 1 : 0], this.getX() + 30, this.getY() + (height - 12) / 2, 12, 12);
                        if (friendsToAdd.contains(friend)) FactoryGuiGraphics.of(guiGraphics).blitSprite(Toggle.TICK, this.getX() + 30, this.getY()  + (height - 12) / 2, 14, 12);
