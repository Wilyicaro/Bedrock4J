...
public class ControllerBinding<T extends BindingState> {
    ...
    public static final ControllerBinding<BindingState.Button> DOWN_BUTTON = registerWithDefaults(createButton("down_button", () -> BedrockOptions.invertControllerButtons.get() ? Button.RIGHT : Button.DOWN), o -> List.of(o.keyJump));
    public static final ControllerBinding<BindingState.Button> RIGHT_BUTTON = registerWithDefaults(createButton("right_button",  () -> BedrockOptions.invertControllerButtons.get() ? Button.DOWN : Button.RIGHT), o -> List.of(o.keyDrop));
    public static final ControllerBinding<BindingState.Button> LEFT_BUTTON = createButton("left_button", Button.LEFT);
    ...
    public static final ControllerBinding<BindingState.Button> BACK = registerWithDefaults(createButton("back", Button.BACK), o -> List.of(Bedrock4JClient.keyHostOptions));
    ...
    public static final ControllerBinding<BindingState.Axis> LEFT_STICK = register(new ControllerBinding<>("left_stick", c-> BindingState.Axis.createStick(c, ()-> BedrockOptions.leftStickDeadZone.get().floatValue(), (a, s)->{}, true), false));
    public static final ControllerBinding<BindingState.Axis> RIGHT_STICK = register(new ControllerBinding<>("right_stick", c-> BindingState.Axis.createStick(c, ()-> BedrockOptions.rightStickDeadZone.get().floatValue(), ControllerManager::updatePlayerCamera, false), false));
    ...
    public static final ControllerBinding<BindingState.Button> LEFT_BUMPER = registerWithDefaults(createButton("left_bumper", Button.LEFT_BUMPER), o -> List.of(Bedrock4JClient.keyCycleHeldLeft));
    public static final ControllerBinding<BindingState.Button> RIGHT_BUMPER = registerWithDefaults(createButton("right_bumper", Button.RIGHT_BUMPER), o -> List.of(Bedrock4JClient.keyCycleHeldRight));
    public static final ControllerBinding<BindingState.Axis> LEFT_TRIGGER = registerWithDefaults(new ControllerBinding<>("left_trigger", c-> BindingState.Axis.createTrigger(c, ()-> BedrockOptions.leftTriggerDeadZone.get().floatValue(), true)), o-> List.of(o.keyUse));
    public static final ControllerBinding<BindingState.Axis> RIGHT_TRIGGER = registerWithDefaults(new ControllerBinding<>("right_trigger", c-> BindingState.Axis.createTrigger(c, ()-> BedrockOptions.rightTriggerDeadZone.get().floatValue(), false)), o-> List.of(o.keyAttack));
    public static final ControllerBinding<BindingState.Button> DPAD_UP = registerWithDefaults(createButton("dpad_up", Button.DPAD_UP), o -> List.of(Bedrock4JClient.keyFlyUp));
    public static final ControllerBinding<BindingState.Button> DPAD_DOWN = registerWithDefaults(createButton("dpad_down", Button.DPAD_DOWN), o -> List.of(Bedrock4JClient.keyFlyDown));
    public static final ControllerBinding<BindingState.Button> DPAD_LEFT = registerWithDefaults(createButton("dpad_left", Button.DPAD_LEFT), o -> List.of(Bedrock4JClient.keyFlyLeft));
    public static final ControllerBinding<BindingState.Button> DPAD_RIGHT = registerWithDefaults(createButton("dpad_right", Button.DPAD_RIGHT), o -> List.of(Bedrock4JClient.keyFlyRight));
